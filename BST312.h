...
template<class ItemType>
void BST_312 <ItemType>::makeEmpty(TreeNode*& t)    //passing a reference to a tree node
{
    //YOUR CODE GOES HERE
    ...
    delete t;   //t is the root because we were passed in t
}
...
template<class ItemType>
void BST_312 <ItemType>::insertItem(const ItemType& newItem)    //insert a value without a node
{
    //YOUR CODE GOES HERE
